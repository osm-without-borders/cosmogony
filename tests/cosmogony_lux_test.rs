...
fn test_lux_zone_types() {
    ...
    assert_eq!(lux.international_labels.get("fr"), Some(&"Luxembourg, Canton Luxembourg, Grand-duché de Luxembourg".to_string()));
    assert_eq!(lux.international_labels.get("de"), Some(&"Luxemburg, Kanton Luxemburg, Großherzogtum Luxemburg".to_string()));
    ...
    assert!(!lux.tags.is_empty());
    assert_eq!(lux.international_labels.get("fr"), Some(&"Grand-duché de Luxembourg".to_string()));
    assert_eq!(lux.international_labels.get("de"), Some(&"Großherzogtum Luxemburg".to_string()));
}
